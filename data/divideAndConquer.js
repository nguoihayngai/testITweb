...
export const divideAndConquer = {
  ...
  content: [
    ...
    { type: 'paragraph', text: 'Tính aⁿ hiệu quả hơn bằng cách chia bài toán thành các phép tính nhỏ hơn. Ví dụ, a⁸ = (a⁴)² = ((a²)²)². Điều này giảm độ phức tạp từ O(n) xuống O(log n).' },
    { type: 'code', snippets: {
